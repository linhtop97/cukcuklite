...
import static vn.com.misa.cukcuk.data.db.IDBUtils.ITableAccountUtils.ACCOUNT_TBL_NAME;
import static vn.com.misa.cukcuk.data.db.IDBUtils.ITableDishUtils.DISH_TBL_NAME;
import static vn.com.misa.cukcuk.data.db.IDBUtils.ITableUnitUtils.UNIT_TBL_NAME;
...
public class SQLiteDBManager extends SQLiteOpenHelper implements IDBUtils {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        //xóa các bảng nếu đã tồn tại trong ứng dụng
        db.execSQL("DROP TABLE IF EXISTS " + ACCOUNT_TBL_NAME);
        db.execSQL("DROP TABLE IF EXISTS " + DISH_TBL_NAME);
        db.execSQL("DROP TABLE IF EXISTS " + UNIT_TBL_NAME);
        onCreate(db);
    }
